...
from utils import shared, shared_with_init
...
class EmbeddingLayer(object):
    ...
    def __init__(self, input_dim, output_dim, name='embedding_layer', initializer=None):
        """
        ...
        if initializer is None:
            ...
            self.embeddings = shared_with_init(self.name + '__embeddings', initializer.astype(np.float32))
